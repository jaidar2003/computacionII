import os
import json
from cli.utils.config import SERVER_HOST, SERVER_PORT, SESSION_FILE
from cli.utils.session import save_session, load_session, clear_session
from cli.utils.connection import create_ssl_connection, receive_prompt, send_response
...
def login(username, password):
    ...
    print_info(f"Conectando al servidor {SERVER_HOST}:{SERVER_PORT}...")
