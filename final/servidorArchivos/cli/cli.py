...
from .commands import auth, files, permissions, config
from .utils.visual import print_info, print_error, print_header, BOLD, RESET
...
def main():
    ...
    if args.host:
        ...
        # Actualizar la variable en el módulo config usando la función recargar_configuracion
        from .utils import config
        config.recargar_configuracion()
