...
def recargar_configuracion():
    ...
    if port_str:
        try:
            ...
            print(f"⚠️ El puerto configurado '{port_str}' no es válido. Debe ser un número.")
            # No salir, mantener el valor anterior
...
def configuracion_inicial():
    ...
    from .visual import print_header, print_info, print_success, print_error, BOLD, RESET
