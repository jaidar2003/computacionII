"""
Módulo de procesamiento de comandos para el cliente.

Este módulo contiene las funciones relacionadas con el procesamiento
de comandos enviados al servidor de archivos.
"""
...
def verificar_estado_archivo(conexion, nombre_archivo, max_intentos=3, espera_entre_intentos=2):
    ...
    Args:
        ...
        max_intentos (int): Número máximo de intentos de verificación
        espera_entre_intentos (int): Tiempo de espera entre intentos en segundos
        
    Returns:
        tuple: (verificacion_completa, integridad_ok, antivirus_ok)
    """
...
def procesar_comando_crear(comando, conexion):
    """
    Procesa el comando CREAR/SUBIR.
    ...
    Returns:
        str or None: Comando modificado o None si ya se manejó la respuesta
    """
    partes = comando.split()
    if len(partes) < 2:
